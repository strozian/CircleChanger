...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.fill_color_original = colors
        self.count_of_color_changes = 0
    def __repr__(self):
        """
        What comes in:
          -- self
    ...
    def swallow(self, other_circle_changer):
        ...
        self.circle.radius = (self.get_distance_from(other_circle_changer.circle.center))
        colors = self.colors + other_circle_changer.colors
        c = CircleChanger(self.circle.center.x,self.circle.center.y, self.circle.radius, 'red', colors)
        return c
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.fill_color_original
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.count_of_color_changes]
        self.count_of_color_changes += 1
        if self.count_of_color_changes >= len(self.colors):
            self.count_of_color_changes = 0
